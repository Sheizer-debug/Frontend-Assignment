...
export default function InputField ({currentField,formData,handleChange,checked})
{
    ...
    return (
        ...
        : checked ?
                ...
                <TextField id={currentField.label} value={formData[key]} onChange={(event)=>handleChange(event,key)} sx={{width:"17.2rem", height:"100%",backgroundColor:"#F0F7FF",border: "1px solid aliceblue" }} variant="outlined" />
            </Stack>
        :null
    );
}